...
public class SequenceFlowTest {
    ...
    public void deploymentProcessDefinition_inputStream(){
        ...
        InputStream inputStreamBpmn = this.getClass().getResourceAsStream("/sequenceFlow/sequenceFlow.bpmn");
        InputStream inputStreamPng = this.getClass().getResourceAsStream("/sequenceFlow/sequenceFlow.png");
